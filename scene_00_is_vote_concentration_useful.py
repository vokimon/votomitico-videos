...
def is_vote_concentration_useful(self):
    init_params(self)
    create_bars(self)
    animate_source_impulse(self)
    split_splinters_from_source(self)
    animate_splinters_jump(self)
    join_splinters_on_target(self)
...
def animate_source_impulse(self):
...
def split_splinters_from_source(self):
...
def animate_splinters_jump(self):
...
def join_splinters_on_target(self):
